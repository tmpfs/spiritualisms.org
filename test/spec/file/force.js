...
describe('file (?force=1):', function() {
  ...
  it('should GET markdown document', function(done) {
    var opts = {
      url: process.env.FILES + '/' + id + '.md?force=1'
    }
  ...
  it('should GET text document', function(done) {
    var opts = {
      url: process.env.FILES + '/' + id + '.txt?force=1'
    }
    request(opts, function(err, res) {
      expect(err).to.eql(null);
      assert(res);
  ...
  it('should GET pdf document', function(done) {
    var opts = {
      url: process.env.FILES + '/' + id + '.pdf?force=1'
    }
    request(opts, function(err, res) {
      expect(err).to.eql(null);
      assert(res);
  ...
  it('should GET json document', function(done) {
    var opts = {
      url: process.env.FILES + '/' + id + '.json?force=1'
    }
    request(opts, function(err, res) {
      expect(err).to.eql(null);
      assert(res);
  ...
  it('should GET pretty json document', function(done) {
    var opts = {
      url: process.env.FILES + '/' + id + '.json?pretty=1&force=1'
    }
    request(opts, function(err, res) {
      expect(err).to.eql(null);
      assert(res);
  ...
  it('should GET html document', function(done) {
    var opts = {
      url: process.env.FILES + '/' + id + '.html?force=1'
    }
    request(opts, function(err, res) {
      expect(err).to.eql(null);
      assert(res);
  ...
  it('should GET xml document', function(done) {
    var opts = {
      url: process.env.FILES + '/' + id + '.xml?force=1'
    }
    request(opts, function(err, res) {
      expect(err).to.eql(null);
      assert(res);
  ...
  it('should GET jpg document', function(done) {
    var opts = {
      url: process.env.FILES + '/' + id + '.jpg?force=1'
    }
    request(opts, function(err, res) {
      expect(err).to.eql(null);
      assert(res);
